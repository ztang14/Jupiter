...
public class TicketMasterClient {
	...
	private static final String API_KEY = "9kFHO18dNqUS7iINMiuNhR9n5WsVerV3";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			if (!obj.isNull("_embedded")) {
				...
				return (List<Item>) getItemList(embedded.getJSONArray("events"));
			}
	...
	public static void main(String[] args) {
		...
		List<Item> events = (List<Item>) client.search(37.38, -122.08, null);
